...
"""
Benchmark utilities specifically for EmbeddingBagCollection (EBC) and QuantEmbeddingBagCollection (QEBC) modules.

This module contains functions for benchmarking EBC and QEBC modules with different sharding strategies and compilation modes.
"""
...
def benchmark_ebc_module(
    ...
    # logging.info(f"###### Benchmarking EBC/QEBC Module: {module} ######\n")
